...
#  panel_border()
#bias_mu
#ggsave(bias_mu, file="figuresPaper_plots/bias_mu.pdf")
#
#
### ----bias_mu_noOut------------------------------------------------------------
...
#  panel_border() +
#  geom_hline(yintercept = 0, col = 'red') + coord_cartesian(ylim = c(-4,4))
#bias_mu_noOut
#ggsave(bias_mu_noOut, file="figuresPaper_plots/bias_mu_noOut.pdf")
#
#
### ----bias_pi------------------------------------------------------------------
...
#  geom_hline(yintercept = 0, col = 'red')
#bias_pi
#ggsave(bias_pi, file="figuresPaper_plots/bias_pi.pdf")
#
#
### ----bias_pi_noOut------------------------------------------------------------
...
#  facet_grid(disp ~ V) + xlab('') + background_grid(major = 'y', minor = "none") + 
#  panel_border() +
#  geom_hline(yintercept = 0, col = 'red') + coord_cartesian(ylim = c(-.5,.5))
#bias_pi_noOut
#ggsave(bias_pi_noOut, file="figuresPaper_plots/bias_pi_noOut.pdf")
#
#
### ----MSE_mu-------------------------------------------------------------------
...
#  geom_hline(yintercept = 0, col = 'red')
#MSE_mu
#ggsave(MSE_mu, file="figuresPaper_plots/MSE_mu.pdf")
#
#
### ----MSE_mu_noOut-------------------------------------------------------------
...
#   ylab(expression(paste('MSE log(', mu, ')'))) + 
#  facet_grid(disp ~ V) + coord_cartesian(ylim = c(0,8)) +
#  background_grid(major = 'y', minor = "none") + 
#  panel_border() +
#  geom_hline(yintercept = 0, col = 'red')
#MSE_mu_noOut
#ggsave(MSE_mu_noOut, file="figuresPaper_plots/MSE_mu_noOut.pdf")
#
#
### ----MSE_pi-------------------------------------------------------------------
...
#  geom_hline(yintercept = 0, col = 'red')
#MSE_pi
#ggsave(MSE_pi, file="figuresPaper_plots/MSE_pi.pdf")
#
#
### ----MSE_pi_noOut-------------------------------------------------------------
...
#  background_grid(major = 'y', minor = "none") + 
#  panel_border() +
#  facet_grid(disp ~ V) + coord_cartesian(ylim = c(0,1)) +
#  geom_hline(yintercept = 0, col = 'red')
#MSE_pi_noOut
#ggsave(MSE_pi_noOut, file="figuresPaper_plots/MSE_pi_noOut.pdf")
#
#
### ----variance_mu, dependson=c("options", "savePaper")-------------------------
...
#  background_grid(major = 'y', minor = "none") + 
#  panel_border() +
#  facet_grid(disp ~ V) + coord_cartesian(ylim = c(0,.3)) +
#  geom_hline(yintercept = 0, col = 'red')
#variance_pi_noOut
#
#ggsave(variance_mu, file="figuresPaper_plots/variance_mu.pdf")
#ggsave(variance_mu_noOut, file="figuresPaper_plots/variance_mu_noOut.pdf")
#ggsave(variance_pi, file="figuresPaper_plots/variance_pi.pdf")
#ggsave(variance_pi_noOut, file="figuresPaper_plots/variance_pi_noOut.pdf")
#
#
### ----variancePlot-------------------------------------------------------------
## save figure 6
...
#save_plot("figuresPaper_plots/bias_mse_allParam_figure6.pdf",
#          p1, ncol = 2, nrow = 2, base_aspect_ratio = 1.3)
#
## save figure S24
#p2 = plot_grid(bias_mu, bias_pi, MSE_mu, MSE_pi, align = "h",
#               labels = c("a", "b", "c", "d"), ncol = 2, nrow = 2)
#save_plot("figuresPaper_plots/bias_mse_allParam_outliers_figureS24.png",device = 'png', p2, ncol = 2, nrow = 2, base_aspect_ratio = 1.3)
#
## save figure S25
#p3 = plot_grid(variance_mu, variance_pi, variance_mu_noOut, variance_pi_noOut,
#               align = "h", labels = c("a", "b", "c", "d"), ncol = 2, nrow = 2)
#save_plot("figuresPaper_plots/variance_allParam_figureS25.png",device ='png',
...
#
## save figure S12
#pdf('figuresPaper_plots/mdMu_S12.pdf', width = 10)
#smoothScatter(meanMu, diffMu, bandwidth = .1, xlab = 'Mean',
#              ylab = 'Difference')
#abline(h = 0, col = 'gray')
#dev.off()
#
#pdf('figuresPaper_plots/mdPi_S12.pdf', width = 10)
...
bias_MSE_ncells
# save figure S9
ggsave(filename="figuresPaper_plots/bias_mse_ncells.png",
