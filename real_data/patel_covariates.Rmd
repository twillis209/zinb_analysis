...
zinb_batch <- zinbFit(raw[vargenes2, subset], K = 2, X=model.matrix(~batch[subset]), epsilon=1e3)
...
zinb_sub1 <- zinbFit(raw[vargenes2, subset], K = 2, epsilon=1e3)
...
zinb_sub2 <- zinbFit(raw[vargenes2, subset], K = 2, X=model.matrix(~batch[subset]), epsilon=1e3)
