...
```{r zinb_batch}
zinb_batch <- fitZinbAndCache(raw[vargenes,], K = 2, X=model.matrix(~Batch, data=targets), epsilon=1e3)
...
zinb_qc <- fitZinbAndCache(raw[vargenes,], K = 2, X=model.matrix(~qcpca$x[,1:2]), epsilon=1e3)
